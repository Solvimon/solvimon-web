...
This section covers everything you need to develop and release the Solvimon Web SDK. Start with the setup guide to get your local environment running, then refer to the publishing guide when you are ready to cut a release.
...
- [Public Types](public-types.md) — the type contract consumers build against, why it exists, and the checks that keep it honest.
