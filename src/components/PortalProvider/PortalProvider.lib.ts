...
import { PortalUrl, PortalUrlCustomer } from "../../services/portal.types";

export const PORTAL_INJECTION_KEY: InjectionKey<ReturnType<typeof getPortal>> = Symbol('portalObject');
