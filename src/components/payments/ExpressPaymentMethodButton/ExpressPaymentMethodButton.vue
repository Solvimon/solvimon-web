...
const props = defineProps<ExpressPaymentMethodButtonProps>();
...
const buttonClasses = computed(() => {
    switch (props.type) {
        case 'applepay':
            return '!bg-black !py-0';
        case 'googlepay':
            return '!bg-black bg-[url(https://www.gstatic.com/instantbuy/svg/dark_gpay.svg)] bg-[length:auto_42.5%]';
        case 'paypal':
            return '!bg-[#ffc439]';
        default:
            return undefined;
...
<template>
    ...
    >
        <template v-if="props.type === 'applepay'">
            <svg id="svg-logo" viewBox="0 0 35 15" class="h-[44px]">
        ...
        <template v-else-if="props.type === 'paypal'">
            <img
