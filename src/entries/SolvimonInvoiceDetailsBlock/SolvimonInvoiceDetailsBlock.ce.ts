...
export const SolvimonInvoiceDetailsBlock = defineCustomElement(SolvimonInvoiceDetailsBlockVue);
export const COMPONENT_NAME = getComponentName('invoice-details-block');
