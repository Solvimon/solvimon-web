...
export const getPricingCurrencyForCountry = ({
    country,
    ...
    const supportedCurrencies = pricingCurrencySettings?.pricing_currencies ?? [];

    if (countryCurrency && supportedCurrencies.includes(countryCurrency)) {
        return countryCurrency;
    }

    return pricingCurrencySettings?.default_pricing_currency ?? fallbackCurrency ?? countryCurrency;
};
